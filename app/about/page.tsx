  ...
  const executiveTeam = [
    {
      ...
      initials: "AK",
      bio: "Abbey serves as the President of the Ugandan Society in British Columbia, providing strategic leadership and vision to advance the Society's mission, strengthen community engagement, and promote sustainable organizational growth. He is committed to fostering unity, preserving Ugandan cultural heritage, and creating opportunities that empower Ugandans across British Columbia. Abbey is an experienced accounting and taxation professional with extensive expertise in financial management, regulatory compliance, and organizational governance. His strong leadership, integrity, and dedication to service have made him a respected figure within the community.In addition to his role with the Society, Abbey serves as a Board Member of the Kabaka Foundation Canada, contributing to initiatives that promote education, health, culture, and community development within the Ugandan diaspora. As President, Abbey is committed to building an inclusive, transparent, and vibrant organization that celebrates Ugandan heritage, supports members' personal and professional growth, and strengthens partnerships that benefit the wider community.",
    },
    {
      name: "Louis Maruk",
